...
public class EasyShoppingSqlConstants {
	...
	public static final String GET_COMPANY_BY_NAME = "SELECT c FROM CompanyEntity c WHERE (c.name LIKE %:name% or c.registeredNumber LIKE %:name% or c.email LIKE %:name%)";
