...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
			...
			.antMatchers(API_CREDIT_CARDS).hasRole(Profile.getProfileName(Profile.CUSTOMER))
			.antMatchers(HttpMethod.DELETE ,API_CREDIT_CARDS + ID).hasRole(Profile.getProfileName(Profile.CUSTOMER))
