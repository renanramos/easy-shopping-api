...
public class ExceptionMessagesConstants {
	...
	public static final String CUSTOMER_NOT_FOUND = "Cliente não localizado/inválido.";
	public static final String ADDRESS_NOT_FOUND = "Endereço não localizado/inválido.";
